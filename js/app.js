...
/***/ function(module, exports, __webpack_require__) {
	...
	var React=__webpack_require__(1);
	var ReactDOM=__webpack_require__(33);
	var ComponentSearchList=__webpack_require__(171);
	var Component={
		//监听文本框变化值
			...
			return(
				React.createElement("div", {className: "shopitem"}, 
							...
							React.createElement("div", {className: "itemdesc"}, 
								...
								React.createElement("div", {className: "goodsPrice"}, "￥", React.createElement("span", null, this.props.name.price)), 
								React.createElement("div", {className: "goodsDiscount"}, this.props.name.discount), 
								React.createElement("div", {className: "goodsBtn"}, 
								  React.createElement("img", {onClick: this.selectShops, className: "goodsBtnImg", src: "img/shopcar.png", title: this.props.name.goodsID})
								)
							)
				)
			);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React=__webpack_require__(1);
	var Tool=__webpack_require__(175);
	/**页脚组件---开始**/
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ComponentRegister =__webpack_require__(176);
	...
	var ComponentShopCar=__webpack_require__(177);
	...
	var Tool={
		dispacher:function(event){
			...
			switch(_title){
				...
				case "2":
				  _style.left="40%";
				  //购物车----1.卸载banner里面的内容，search里面的内容,list里面内容
				  var id=["search-comp","banner-comp","list-comp"];
	              this.unmountComponentById(id);
	                var _comp=[{ComponentShopCar:"list-comp"}];
	              this.mountComponentById(_comp);
				break;
		...
		register:function(){
			...
			$.post('http://datainfo.duapp.com/shopdata/userinfo.php',_json,function(data){
				if(data=="1"){
					...
					//打开登陆界面
					ReactDOM.unmountComponentAtNode(document.getElementById("list-comp"));
					ReactDOM.render(React.createElement(ComponentLogin, null),document.getElementById("list-comp"));
	...
	var ComponentLogin=React.createClass({displayName: "ComponentLogin",
		...
		render:function(){
			...
			return(
				React.createElement("div", {className: "register"}, 
			       React.createElement("div", {className: "username", style: _css.margin}, 
			          React.createElement("label", null, "用户名:"), React.createElement("input", {placeholder: "用户登录", id: "username", type: "text"})
			       ), 
			       React.createElement("div", {className: "password", style: _css.pass}, 
			          React.createElement("label", null, "密码:"), React.createElement("input", {id: "password", type: "password"})
			       ), 
			       React.createElement("div", {className: "userbtn", style: _css.pass}, 
			           React.createElement("img", {onClick: this.login, style: _css.img, src: "img/regs.png"})
			       )
			    )
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOM=__webpack_require__(33);
	var Component=__webpack_require__(170);
	var ComponentShopCar=React.createClass({displayName: "ComponentShopCar",
		mixins:[Component],
		...
		render:function(){
			...
			this.state.result.map(function(item){
				//2.让子组建叠加（子组建内部只负责解析数据）
		 	    list.push(React.createElement(ComponentShopCarItem, {name: item}));
		 	});
			return(
				React.createElement("div", null, 
				    React.createElement("div", {className: "shopbar"}), 
				    React.createElement("div", {className: "shoplist"}, 
				      /** 3.将叠加的结果放在父组建中 ----列表出现**/
				      list
				    )
	...
	var total=1;
	var ComponentShopCarItem=React.createClass({displayName: "ComponentShopCarItem",
		...
		removeGoods:function(event){
			...
			$.post(httpurl,_jsons,function(data){
				...
				if(data=='1'){
					if(_total==0){
						ReactDOM.unmountComponentAtNode(document.getElementById('list-comp'));
						ReactDOM.render(React.createElement(ComponentShopCar, null),document.getElementById('list-comp'))
					}else{
		...
		render:function(){
			...
			return(
				 React.createElement("div", {className: "shopitem"}, 
					...
					React.createElement("div", {className: "itemdesc", style: css.item}, 
						React.createElement("div", {className: "goodsName"}, this.props.name.goodsName), 
						React.createElement("div", {className: "goodsPrice"}, "￥", React.createElement("span", null, this.props.name.price)), 
						React.createElement("div", {className: "goodsDiscount"}), 
						React.createElement("div", {className: "goodsOperate"}, 
						    React.createElement("button", {onClick: this.removeGoods}, "-"), 
						    React.createElement("input", {value: this.props.name.number, type: "text", title: this.props.name.goodsID, id: "currentNumber"}), 
						    React.createElement("button", {onClick: this.addGoods}, "+")
						)
					)
				 )
			);
